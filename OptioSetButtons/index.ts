  ...
  implements ComponentFramework.ReactControl<IInputs, IOutputs>
{
  ...
  public init(
    ...
    this.selectedOption = context.parameters.sourceControl.raw??0;
  }
  ...
  public updateView(
    ...
    console.log(sourceControl.attributes?.Options)

    return React.createElement(HelloWorld, {
      color: context.parameters.Color.raw,
      theme: context.parameters.ThemeMode.raw,
  ...
  public getOutputs(): IOutputs {
    return {
        sourceControl : this.selectedOption
    };
  }
